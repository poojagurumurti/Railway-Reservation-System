...
def reservation(request):
    if request.method == "POST":
        ...
        trainname = request.POST.get('trainno')
        ...
        reservation = Reservation(
            name=name, age=age, gender=gender, medicalpractitioner=medicalpractitioner, seniorcitizen=seniorcitizen,
            trainno=trainno, trainname=trainname, classname=classname, noofseat=noofseat, stationfrom=stationfrom, stationto=stationto)
        reservation.save()
